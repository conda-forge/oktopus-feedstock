...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/oktopus-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/oktopus-feedstock)
...
Once the `conda-forge` channel has been enabled, `oktopus` can be installed with:

```
conda install oktopus
```

It is possible to list all of the versions of `oktopus` available on your platform with:
